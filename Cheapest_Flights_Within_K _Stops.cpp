...
// Here is Code of this Above problem!!
// Time Complexity of this Code is O(ElogV), where E is Edges & V is vartices of a graph!!

// This is the Directed Weighted Graph!!
...
public:
    int findCheapestPrice(int n, vector<vector<int>>& flights, int src, int dst, int k) {
        ...
        //Push intial Value of Stops, Node And Cost!!
        q.push({0,{src,0}});
